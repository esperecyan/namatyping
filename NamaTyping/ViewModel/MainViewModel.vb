...
#End Region
        ...
        Protected Function NameEntryProcedure(comment As LiveCommentMessage) As Boolean
            ...
            If settingFlagsChanged Then
                Dim settings = If(
                    user.SettingFlags <> "",
                    String.Join("", From flag In NamaTyping.User.SettingFlagList Where user.SettingFlags.Contains(flag.Value) Select $"「{flag.Key}」"),
                    "設定を削除"
                )
                    ...
                    For i = user.LyricsIndex To _lyricsIndex - 1
                        ...
                        For j = start To _lyrics.Lines(i).Words.Count - 1
                            ...
                            Else
                                ...
                                ElseIf scored And Not user.SettingFlags.Contains(NamaTyping.User.SettingFlagList("version 2 like")) Then
                                    Exit Do
