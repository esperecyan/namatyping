...
Partial Public Class ScreenWindow
    ...
    Private Sub ChangeWindowSize(size As String)
        ...
        ScreenControl.MyImage.Width = ScreenControl.Grid.Width
        ScreenControl.MyImage.Height = ScreenControl.Grid.Height
        ScreenControl.MyMediaElement.Width = ScreenControl.Grid.Width
        ScreenControl.MyMediaElement.Height = ScreenControl.Grid.Height
    End Sub
